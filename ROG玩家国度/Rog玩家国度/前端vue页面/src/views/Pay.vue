  ...
  <div class="pay">
    ...
    <div class="pay-box">
      <div class="select-address">
        <div>
          <span @click="showSelectAddressList" style="font-weight:1000;color:orange">选择地址</span>
          <van-icon class="arrow" name="arrow" />
        </div>
        <div class="user-box">
          <div class="user-info">
            <div class="user-name">收件人：{{currentAddress.name?currentAddress.name:'无'}}</div>
            <div class="user-phone">电话：{{currentAddress.tel?currentAddress.tel:'无'}}</div>
            <div class="default-address" v-if="currentAddress.isDefault">默认</div>
          </div>
          <div class="detail-address">详细地址：{{currentAddress.address?currentAddress.address:'无'}}</div>
        </div>
      </div>
      <!-- 订单信息 -->
