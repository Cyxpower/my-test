...
var Model = Sequelize.Model; //定义一个商家validcode数据表结构

var Validcode =
/*#__PURE__*/
function (_Model) {
  _inherits(Validcode, _Model);

  function Validcode() {
    _classCallCheck(this, Validcode);

    return _possibleConstructorReturn(this, _getPrototypeOf(Validcode).apply(this, arguments));
  }

  return Validcode;
}(Model); //定义validcode表结构
